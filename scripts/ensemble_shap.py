...
rf.fit(X_train, y_train)  # NEW: Fit RF explicitly for SHAP compatibility
...
# Improved LSTMWrapper for sklearn compatibility
...
# SHAP explainability (using the now-fitted RF base for tree-based SHAP)
